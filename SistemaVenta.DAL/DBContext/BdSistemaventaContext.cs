...
public partial class BdSistemaventaContext : DbContext
{
    public BdSistemaventaContext()
    {
    }

    public BdSistemaventaContext(DbContextOptions<BdSistemaventaContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C1694A0AA");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FB5E41443");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48322DEF7A4");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E10770159737");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E32481829");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13271C1E03C");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76E45C36AF");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D80F5D858C");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE686C8133");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6C156B1CE");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614408C56BD");
